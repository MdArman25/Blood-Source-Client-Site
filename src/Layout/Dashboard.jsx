...
const Dashboard = () => {
  ...
  console.log(isAdminLoading, isAdmin,isVolunteer);
  ...
  <ul className="menu p-4 text-slate-100 text-xl ">
  {isAdmin?.isAdmin ? (
            
            <div className="grid  h-full p-3 md:w-60 dark:bg-gray-900 dark:text-gray-100">
              <div className="space-y-3">
                ...
                <div className="relative  md:w-fit lg:w-full">
                  ...
                  <ul className="pt-2 pb-4 space-y-1 text-sm">
                    <NavLink  to={"/Dashboard/AdminProfile"}>
                      <li className="rounded-sm">
                        ...
                        >
                          <MdBroadcastOnHome className="text-xl font-bold" />
                          <span>DashBoard</span>
                        </a>
                      </li>
                    </NavLink>
                    ...
                    <NavLink to={'/Dashboard/All_donation_request'}>
                      <li className="rounded-sm">
                        <a
                          rel="noopener noreferrer"
                          className="flex items-center p-2 space-x-3 rounded-md"
    ...
    <li>
      ...
      {/* dashboard content */}
      <div className="col-span-3  md:col-span-2 p">
        <Outlet></Outlet>
      </div>
    </div>
  );
